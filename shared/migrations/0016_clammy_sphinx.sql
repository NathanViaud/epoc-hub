...
CREATE UNIQUE INDEX `libraries_user_unique` ON `libraries` (`user`);--> statement-breakpoint
...
CREATE TABLE `__new_epocs` (
	...
	`user` text NOT NULL,
	`createdAt` integer DEFAULT '"2025-05-11T19:24:19.374Z"',
	FOREIGN KEY (`user`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-05-11T19:24:19.374Z"',
	`updatedAt` integer DEFAULT '"2025-05-11T19:24:19.374Z"',
