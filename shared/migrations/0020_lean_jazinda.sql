...
CREATE TABLE `__new_epocs` (
	...
	`user` text NOT NULL,
	`createdAt` integer DEFAULT '"2025-05-14T14:15:49.925Z"',
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-05-14T14:15:49.926Z"',
	`updatedAt` integer DEFAULT '"2025-05-14T14:15:49.926Z"',
