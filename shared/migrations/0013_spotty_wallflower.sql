...
CREATE TABLE `__new_epocs` (
	...
	`file` text NOT NULL,
	`user` text NOT NULL,
	`createdAt` integer DEFAULT '"2025-04-27T14:04:20.364Z"',
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-04-27T14:04:20.365Z"',
	`updatedAt` integer DEFAULT '"2025-04-27T14:04:20.365Z"',
