...
CREATE TABLE `__new_epocs` (
	...
	`user` text NOT NULL,
	`created_at` integer DEFAULT '"2025-05-14T16:16:47.691Z"',
	`updated_at` integer DEFAULT '"2025-05-14T16:16:47.691Z"',
	FOREIGN KEY (`user`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
INSERT INTO `__new_epocs`("id", "title", "image", "file", "downloads", "user", "created_at", "updated_at") SELECT "id", "title", "image", "file", "downloads", "user", "created_at", "updated_at" FROM `epocs`;--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-05-14T16:16:47.691Z"',
	`updatedAt` integer DEFAULT '"2025-05-14T16:16:47.691Z"',
