...
CREATE TABLE `__new_epocs` (
	...
	`file` text NOT NULL,
	`user` text NOT NULL,
	`createdAt` integer DEFAULT '"2025-04-27T13:32:20.066Z"',
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-04-27T13:32:20.067Z"',
	`updatedAt` integer DEFAULT '"2025-04-27T13:32:20.067Z"',
